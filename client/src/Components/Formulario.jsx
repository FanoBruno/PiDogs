...
export default function Formulario(){
    ...
    function validator(inputs){
        ...
        if(!inputs.name){
            ...
            error.weight_max = "Max weight is required"
        } else if (inputs.weight_max < inputs.weight_min){
            error.weight_min = "Min weight should be smaller than max weight"
        } else if (!inputs.height_min) {
            error.height_min = "Min height is required"
        } else if (!inputs.height_max) {
            error.height_max = "Max height is required"
            ...
            error.weight_min = "Min weight should be a slower number than max weight"
        } */
        return error
    }
